...
# Template: app
# Command: C:\Qt\6.5.2\mingw_64\bin\qmake.exe -o Makefile Calculator.pro -spec win32-g++ "CONFIG+=qtquickcompiler"
#############################################################################
...
Makefile: Calculator.pro C:/Qt/6.5.2/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.5.2/mingw_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile Calculator.pro -spec win32-g++ "CONFIG+=qtquickcompiler"
